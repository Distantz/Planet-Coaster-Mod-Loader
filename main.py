...
class Gui():
    ...
    def restore(self):
        for i, self.widgetToDestroy  in enumerate(self.modWidgetList):
            self.modWidgetList[i].destroy()
            #self.widgetToDestroy.destroy()
...
class ModTileWidget():
    ...
    def destroy(self):
        ...
        if self.modFile in self.gui.modList:
            ...
            self.gui.modList.pop(self.gui.modList.index(self.modFile))
            self.gui.modWidgetList.pop(self.gui.modWidgetList.index(self))
